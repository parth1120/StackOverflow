...
render() {
  ...
  <div className="FormCenter">
   <div>
      ...
      <input  className="FormField__Input" className="FormField__Input" placeholder="Enter your Name" type="text" onChange={this.changeName} value={this.state.name }/>
      ...
      <input className="FormField__Input" type="email" placeholder="Enter your Email" onChange={this.changeEmail} value={this.state.email}/>
      ...
      <input  className="FormField__Input" className="FormField__Input" placeholder="Enter your Number" type="text" onChange={this.changeNo} placeholder="Enter your email" value={this.state.no}/>
      ...
      <input  className="FormField__Input" className="FormField__Input" placeholder="Enter your Password" type="password" onChange={this.changePass} value={this.state.pass}/>
